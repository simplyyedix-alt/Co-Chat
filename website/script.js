...
if (videoScreen && playButton) {
  videoScreen.insertAdjacentHTML('afterbegin', '<div class="tour-interface"><aside><span class="tour-logo">C</span><strong>Co‑Chat</strong><small>Messages</small><small>Calls</small><small>Stories</small><small>Profile</small></aside><div class="tour-main"><div class="tour-top"><b class="tour-stage-title">Messages</b><span>⌕ &nbsp; ◯</span></div><div class="tour-content"><div class="tour-list"><div class="tour-row selected"><i>MP</i><span><b>Maya Patel</b><small>That sounds perfect — see you there!</small></span><time>10:42</time></div><div class="tour-row"><i>DC</i><span><b>Design Crew</b><small>Leo: I added the final screens.</small></span><time>09:15</time></div><div class="tour-row"><i>JK</i><span><b>Jordan Kim</b><small>Thanks for sharing that!</small></span><time>Yesterday</time></div></div><div class="tour-chat"><div class="tour-chat-head"><i>MP</i><b>Maya Patel</b><small>Online</small></div><p class="tour-bubble">Are we still on for coffee?</p><p class="tour-bubble mine">Absolutely! I’ll be there at 4.</p><div class="tour-input">Write a message <b>➤</b></div></div></div></div></div>')
